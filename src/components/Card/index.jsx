			...
			return (
				<Link to={props.url}> 
					<div className="card__img__colection">
						{props.imgs.map(e => <img style={{translate: `${-100 * props.currImg}%`}} alt={props.modelo} className="card__image__custom" src={e} key={e}/>)}
					</div>
				</Link>
			)
		} else {
			return <Link to={props.url}> <img alt={props.modelo} className="card__image__custom" src={props.imgs[0]} /> </Link>
		}
	}
}
